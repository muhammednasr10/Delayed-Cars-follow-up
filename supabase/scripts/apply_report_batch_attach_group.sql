...
-- Fixes: adding a chassis on multi-VIN edit creates a standalone row (null report_group_id)
-- instead of joining the existing report group.
-- Source: migrations/0145_report_batch_attach_group.sql
