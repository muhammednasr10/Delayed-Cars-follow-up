-- Allow a mission assignee who manages subordinates to delegate the mission to them.
...
grant execute on function public.delegate_my_team_mission(uuid, uuid[]) to authenticated;
