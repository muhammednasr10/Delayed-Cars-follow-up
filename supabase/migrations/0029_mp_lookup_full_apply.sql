-- =============================================================================
-- RUN THIS ENTIRE FILE ONCE in Supabase SQL Editor (copy all, then Run).
-- Fixes: mp_reason_options missing, view dependencies, report_group_id, text columns.
-- Safe to re-run (uses IF NOT EXISTS / OR REPLACE).
-- =============================================================================

-- 1) Lookup tables + seed data
...
-- 8) RPCs (batch report + update record)
