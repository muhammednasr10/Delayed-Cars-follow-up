...
export const translations = {
  ar: {
    ...
    mp: {
      ...
      sectionVehicle: 'بيانات السيارة', sectionParts: 'القطع الناقصة',
      f: {
      ...
      vinListTitle: 'أرقام الشاسيه (واحد لكل سيارة)',
      ...
      cols: {
        ...
        dr: 'DR', stopper: 'نوع الإيقاف', createdBy: 'أدخلها', createdAt: 'التاريخ', actions: 'إجراءات'
      },
      ...
      act: {
        update: 'تحديث', title: 'تحديث حالة القطعة', required: 'المطلوب', installed: 'المُركّب', remaining: 'المتبقي',
  ...
  en: {
    ...
    mp: {
      ...
      sectionVehicle: 'Vehicle details', sectionParts: 'Missing parts',
      vinListTitle: 'VIN numbers (one per vehicle)',
      ...
      cols: {
        ...
        dr: 'DR', stopper: 'Stopper', createdBy: 'Entered by', createdAt: 'Date', actions: 'Actions'
      },
      f: {
      ...
      act: {
        update: 'Update', title: 'Update part status', required: 'Required', installed: 'Installed', remaining: 'Remaining',
