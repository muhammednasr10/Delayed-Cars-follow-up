...
export const translations = {
  ar: {
    ...
    common: {
      ...
      noResults: 'لا توجد نتائج مطابقة.', error: 'حدث خطأ.', notPermitted: 'هذا الإجراء غير متاح ضمن صلاحياتك.', unknown: 'غير معروف',
      cannotUndo: 'لا يمكن التراجع.', deleted: 'تم الحذف.'
    },
    export: {
      excel: 'Excel',
      pdf: 'PDF',
    ...
    nav: {
      ...
      training: 'العمالة', ipl: 'IPL', stations: 'المحطات', lineBalancing: 'Line Balancing', sop: 'SOP', settings: 'الإعدادات',
      damagedParts: 'الأجزاء التالفة', missions: 'المهمات', requests: 'الطلبات', scratches: 'الخدوش',
      equipment: 'العدة', feedback: 'المقترحات والشكاوى', workerProfile: 'حسابي'
    },
    sidebar: {
      title: 'القائمة',
    ...
    qualityNotes: {
      ...
      noLineBalancingWorkerLines: 'لا توجد خطوط عمال في توازن الخط لهذه المحطة والموديل — عرّف العمليات في Line Balancing.',
      ...
      summary: { total: 'إجمالي الملاحظات', count: 'العدد', topCategories: 'أكثر التصنيفات', topStations: 'أكثر المحطات' }
    },
    equipment: {
      title: 'العدة',
    ...
    productivity: {
      ...
      tabs: { orders: 'خطة الإنتاج', workDays: 'أيام العمل', productivity: 'الإنتاجية', entry: 'إنتاجية الدخول', exit: 'إنتاجية الخروج', stops: 'التوقفات', summary: 'ملخص الإنتاجية' },
    ...
    productionOrders: {
      ...
      coverageHint: 'الفجوة الموجبة = أوامر أقل من الخطة. السالبة = أوامر أكثر من الخطة. الأوامر تُحسب لشهر الخطة (تاريخ الأمر أو إنشاؤه).',
      coverageStatuses: {
        ok: 'متوازن',
        over: 'أوامر زائدة',
        short: 'أوامر ناقصة',
    ...
    warehouses: {
      ...
      feeding: {
        ...
        subTabs: { plan: 'خطة التغذية', settings: 'إعدادات التغذية', kanban: 'Kanban التغذية', actual: 'التغذية الفعلية' },
        settings: {
        ...
        iplEmptyForFilter: 'لا توجد قطع IPL لهذا الموديل ونوع المخزن — جرّب موديلاً أو مخزناً آخر أو أضف الأجزاء من قسم الهندسة',
    ...
    modules: {
      ...
      workerProfile: 'حسابي', workerProfileDesc: 'حسابك، بيانات العامل، محطتك، العدة، حضورك، مهامك، وصلاحياتك',
    ...
    login: {
      ...
      email: 'البريد الإلكتروني', password: 'كلمة المرور', showPassword: 'إظهار كلمة المرور', hidePassword: 'إخفاء كلمة المرور',
    ...
    mp: {
      ...
      filterSelectedCount: '{n} محدد', filterClear: 'مسح الفلتر',
      ...
      cols: {
        vin: 'رقم الشاسيه', model: 'الموديل', color: 'اللون', station: 'المحطة', orgUnit: 'القسم التنظيمي', part: 'القطعة الناقصة',
    ...
    vehicles: {
      ...
      cols: { vin: 'VIN', model: 'الموديل', color: 'اللون', orgUnit: 'القسم', po: 'أمر الإنتاج', missing: 'النواقص', completion: 'الاكتمال', production: 'الإنتاج', qc: 'الجودة', delivery: 'التسليم' },
    ...
    org: {
      ...
      assemblyWorkforceHint: 'يُعرض هنا فقط من تبعيتهم التنظيمية «الإنتاج / التجميع». السجل الكامل والإضافة من قسم الموارد البشرية.',
      assemblySupervisorScopeHint: 'تعرض عمال مناطق عملك فقط: مشرف تريم أ/ب يرى عمال الدخول، ومشرف الشاسيه/الفاينال يرى عمال الخروج. مساعد المشرف يرث نطاق مشرفه.',
    ...
    bom: {
      ...
      multiple: 'متعدد', modelBreakdown: 'تفاصيل الموديلات', activeInModel: 'في الموديل', deleteGroupHint: 'يشمل {n} صفوف',
      ...
      col: {
        ...
        common_station: 'المحطة الشائعة', common_name: 'اسم شائع', used_in_models: 'الموديلات',
      ...
      rowCount: '{n} صف', mergedRowCount: '{rows} سجل — {groups} جزء بعد الدمج', mergeTruncated: 'القائمة كبيرة جداً؛ الدمج يشمل أول 8000 سجل فقط.',
      normalized: 'الرقم المُطبَّع', occurrences: 'التكرار', stations: 'محطات', models: 'موديلات',
    ...
    permissions: {
      tabs: { users: 'المستخدمون', requests: 'طلبات المستخدمين', roles: 'الأدوار', matrix: 'مصفوفة الصلاحيات', audit: 'سجل التغييرات', activeUsers: 'المستخدمون النشطون', blocked: 'الحسابات المحظورة' },
      audit: {
      ...
      matrix: {
        ...
        userOverrideHint: 'التغييرات هنا تُحفظ كاستثناءات للمستخدم وتتجاوز صلاحيات دوره. عند المطابقة مع الدور يُزال الاستثناء.',
  ...
  en: {
    ...
    common: {
      ...
      noResults: 'No matching results.', error: 'Something went wrong.', notPermitted: 'This action is not available for your permissions.', unknown: 'Unknown',
      cannotUndo: 'This cannot be undone.', deleted: 'Deleted.'
    },
    export: {
      excel: 'Excel',
      pdf: 'PDF',
    ...
    nav: {
      ...
      training: 'Workforce', ipl: 'IPL', stations: 'Stations', lineBalancing: 'Line Balancing', sop: 'SOP', settings: 'Settings',
      damagedParts: 'Damaged parts', missions: 'Missions', requests: 'Requests', scratches: 'Scratches',
      equipment: 'Equipment', feedback: 'Suggestions & complaints', workerProfile: 'My account'
    },
    sidebar: {
      title: 'Menu',
      openMenu: 'Open menu'
    ...
    qualityNotes: {
      ...
      noLineBalancingWorkerLines: 'No worker lines in line balancing for this station/model — define operations in Line Balancing.',
    ...
    workerProfile: {
      ...
      noAllocationTodayHint: 'Once you are assigned in manpower allocation, your station and operations will appear here by model.',
    ...
    productivity: {
      ...
      tabs: { orders: 'Production plan', workDays: 'Working days', productivity: 'Productivity', entry: 'Entry productivity', exit: 'Exit productivity', stops: 'Line stops', summary: 'Productivity summary' },
    ...
    productionOrders: {
      ...
      planEntry: {
        ...
        annualHint: 'The annual plan is a year reference — each month you record the monthly plan and requirements separately.',
      ...
      coverageHint: 'Positive gap = fewer orders than plan. Negative = more orders than plan. Orders are counted for the plan month (order dates or created date).',
      coverageStatuses: {
        ok: 'Balanced',
        over: 'Over plan',
        short: 'Under plan',
    ...
    warehouses: {
      ...
      feeding: {
        ...
        subTabs: { plan: 'Feeding plan', settings: 'Feeding settings', kanban: 'Kanban feeding', actual: 'Actual feeding' },
        settings: {
        ...
        iplEmptyForFilter: 'No IPL parts for this model and warehouse type — try another model, warehouse type, or add parts in Engineering',
    ...
    modules: {
      ...
      workerProfile: 'My account', workerProfileDesc: 'Your account, employee data, station, equipment, attendance, missions, and permissions',
    ...
    mp: {
      ...
      subtitle: 'A station reports a part that was not installed on a vehicle, linked to VIN, model, color and org unit.',
      ...
      issuesListModal: { title: 'Shortage reasons', subtitle: '{n} reasons', open: 'Show shortage reasons', qty: 'Qty' },
      modelSummary: {
      ...
      filterSelectedCount: '{n} selected', filterClear: 'Clear filter',
      ...
      cols: {
        vin: 'VIN', model: 'Model', color: 'Color', orgUnit: 'Org unit', station: 'Station', part: 'Missing part',
    ...
    vehicles: {
      ...
      cols: { vin: 'VIN', model: 'Model', color: 'Color', orgUnit: 'Section', po: 'Prod. Order', missing: 'Missing', completion: 'Completion', production: 'Production', qc: 'QC', delivery: 'Delivery' },
    ...
    org: {
      ...
      assemblyWorkforceHint: 'Only employees with org placement «Production / Assembly» appear here. Full registry and new hires are managed in HR.',
      assemblySupervisorScopeHint: 'You only see workers in your scope: Trim A/B supervisors see entry-line workers; Chassis/Final supervisors see exit-line workers. Assistant supervisors inherit their supervisor’s scope.',
    ...
    bom: {
      ...
      consolidatedHint: 'Cross-model consolidated view — names from the unified parts list; data sourced from IPL models',
      ...
      multiple: 'Multiple', modelBreakdown: 'Model breakdown', activeInModel: 'In model', deleteGroupHint: 'includes {n} rows',
      ...
      col: {
        ...
        common_station: 'Common station', common_name: 'Common name', used_in_models: 'Models',
      ...
      rowCount: '{n} rows', mergedRowCount: '{rows} records — {groups} parts after merge', mergeTruncated: 'List is very large; merge applies to the first 8,000 records only.',
      normalized: 'Normalized', occurrences: 'Occurrences', stations: 'Stations', models: 'Models',
    ...
    permissions: {
      tabs: { users: 'Users', requests: 'User requests', roles: 'Roles', matrix: 'Permission matrix', audit: 'Change log', activeUsers: 'Active users', blocked: 'Blocked accounts' },
      audit: {
      ...
      matrix: {
        ...
        hintUser: 'Edits here are user overrides only — they override the role. Matching the role removes the override.',
        ...
        userOverrideHint: 'Changes here are saved as user overrides and take precedence over the role. Matching the role removes the override.',
      ...
      copy: {
        ...
        hintUser: 'Copy effective permissions from another user onto the selected user (existing overrides are replaced).',
      ...
      control: {
        ...
        hintUser: 'Open each page or tab and set visibility plus actions inside it. Changes here override the user role.',
