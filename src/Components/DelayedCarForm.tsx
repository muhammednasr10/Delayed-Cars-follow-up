    ...
    <section className="card-industrial p-5">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <label className="space-y-2">
          ...
          <select
            className="input-dark"
            value={form.vehicleColorId ?? ''}
            onChange={event => updateField('vehicleColorId', event.target.value || null)}
          >
        ...
        {success && (
          <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-sm text-emerald-200 lg:col-span-2">
            {success}
          </div>
        )}
        ...
        <div className="lg:col-span-2">
          <button
            ...
            className="w-full rounded-xl bg-cyan-500 px-5 py-3 font-black text-slate-950 transition hover:bg-cyan-400 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
          >
