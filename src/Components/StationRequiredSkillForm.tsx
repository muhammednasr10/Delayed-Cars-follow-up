...
export function StationRequiredSkillForm({
  open,
  editing,
  defaultStationId,
  stations,
    ...
    setForm(
      editing
        ? {
            ...
            requiredLevel: editing.requiredLevel,
  ...
  return (
    <Modal
      open={open}
      title={editing ? t('training.srs.editTitle') : t('training.srs.addTitle')}
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <Field label={t('training.srs.level')} required>
          <select
            ...
            onChange={e => set('requiredLevel', e.target.value as TrainingLevel)}
          >
