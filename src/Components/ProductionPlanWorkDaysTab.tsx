  ...
  return (
    <div className="card-industrial p-5 sm:p-6">
      <div className="mb-4 flex flex-col gap-4">
        ...
        >
          <SummaryPill label={t('productionOrders.workDays.available')} value={String(availableDays)} tone="violet" />
          <SummaryPill
                ...
                <tr key={row.workDate} className="bg-slate-900/30 hover:bg-slate-800/40">
                  ...
                  {!isWorkDaysOnly && (
                    <>
                      ...
                      <td className={`${cell} border-e border-slate-800 font-black text-amber-300`}>
                        {formatCount(row.stopLostVehicles)}
                      </td>
                      <td className={`${cell} font-black text-cyan-300`}>
                        {row.entryProductivity ? (
                          <ProductivityBreakdownHover
                            breakdown={dayBreakdown(row.workDate)}
                            kind="entry"
              ...
              <tr className="bg-slate-950/95 text-base font-black">
                ...
                {!isWorkDaysOnly && (
                  <>
                    ...
                    <td className={`${cell} border-e border-slate-800 text-amber-300`}>
                      {formatCount(totals.stopLostVehicles)}
                    </td>
